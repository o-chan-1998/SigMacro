...
Sub Plot()
    ...
    unkonwn1 = _ReadCell(PLOT_TYPE_COL, PLOT_UNKONWN1_ROW)
...
Sub SetScales()
   ...
   xScaleType = _GetScaleType(xScaleData(0, 0))
   yScaleType = _GetScaleType(yScaleData(0, 0))
