...
Sub Plot()
    ...
    For iPlot = 0 To DATA_MAX_NUM_PLOTS - 1
        ...
        ColumnsPerPlot = _GetColumnMapping(plotType, currentColumn)
...
Sub SetXYLabelSizesAndTickLabelSizes()
    ...
    Dim oGraph As Object     ' SigmaPlot.Graph
    Dim oAxisX As Object     ' SigmaPlot.Axis
    Dim oAxisY As Object     ' SigmaPlot.Axis
    Dim oTextX As Object     ' SigmaPlot.Text
    Dim oTextY As Object     ' SigmaPlot.Text    
    Dim oTextXTick As Object ' SigmaPlot.Text
    Dim oTextYTick As Object ' SigmaPlot.Text    

    Set oGraph = ActiveDocument.CurrentPageItem.GraphPages(0).CurrentPageObject(GPT_GRAPH)
    Set oAxisX = oGraph.Axes(HORIZONTAL) ' 0
    Set oAxisY = oGraph.Axes(VERTICAL)   ' 1
    ...
    oTextX.SetAttribute(STA_SIZE, LABEL_PTS_08) ' Use the string constant
    oTextY.SetAttribute(STA_SIZE, LABEL_PTS_08) ' Use the string constant
    
    oTextXTick.SetAttribute(STA_SIZE, LABEL_PTS_07) ' Use the string constant
    oTextYTick.SetAttribute(STA_SIZE, LABEL_PTS_07) ' Use the string constant
...
Sub Main()
   ...
   ActiveDocument.NotebookItems(GRAPH_NAME).Open ' Ensure graph page is active   
